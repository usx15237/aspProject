<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerCenter.aspx.cs" Inherits="CustomerCenter" %>
...
<body>
    <div>
        <h1>welcome to CustomerCenter;</h1>
        您的用户名为:<span id="UserName" runat="server">content</span>
