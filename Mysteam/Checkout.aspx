                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <div class="woocommerce-info">想要优惠券?（满额送） <a class="showcoupon" data-toggle="collapse" href="#coupon-collapse-wrap" aria-expanded="false" aria-controls="coupon-collapse-wrap">点此领取</a>
                            </div>
                                ...
                                <div id="customer_details" class="col2-set">
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <div class="clear"></div>
                                             <p id="billing_name_field" class="form-row form-row-first validate-required validate-email">
                                                <label class="" for="billing_email" id="name">收货人姓名 <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="" id="billing_name" name="billing_email" class="input-text name">
                                            </p>



                                            <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                                                <label class="" for="billing_email" id="Email">收货地址 <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="" id="billing_email" name="billing_email" class="input-text Add">
                                            </p>

                                            <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                                <label class="" for="billing_phone" ">联系电话 <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="" id="billing_phone" name="billing_phone" class="input-text Tel">
                                            </p>
                                            <div class="clear"></div>


                                            <div class="create-account">
                                                <p>通过输入以下信息创建一个帐户。如果您是退货客户，请登录页面顶部。</p>
                                                <p id="account_password_field" class="form-row validate-required">
                                                    <label class="" for="account_password">手机号快速注册<abbr title="required" class="required">*</abbr>
                                                    </label>
                                                    <input type="password" value="" placeholder="telephone" id="account_password" name="account_password" class="input-text">
                                                </p>
                                                <div class="clear"></div>
                                            </div>
                        ...
                        <label class="checkbox" for="ship-to-different-address-checkbox">新增收货地址?</label>
                        <input type="checkbox" value="1" name="ship_to_different_address" checked="checked" class="input-checkbox" id="ship-to-different-address-checkbox">
                                            ...
                                            <div class="shipping_address" style="display: block;">
                                                <p id="shipping_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                                    <label class="" for="shipping_country">国家 <abbr title="required" class="required">*</abbr>
                                                    </label>
                                                ...
                                                <p id="shipping_first_name_field" class="form-row form-row-first validate-required">
                                                    <label class="" for="shipping_first_name">姓 <abbr title="required" class="required">*</abbr>
                                                    </label>
                                                ...
                                                <p id="shipping_last_name_field" class="form-row form-row-last validate-required">
                                                    <label class="" for="shipping_last_name">名 <abbr title="required" class="required">*</abbr>
                                                    </label>
                                                ...
                                                <p id="shipping_company_field" class="form-row form-row-wide">
                                                    <label class="" for="shipping_company">公司名字</label>
                                                    <input type="text" value="" placeholder="" id="shipping_company" name="shipping_company" class="input-text ">
                                                </p>

                                                <p id="shipping_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                    <label class="" for="shipping_address_1">地址 <abbr title="required" class="required">*</abbr>
                                                    </label>
                                                ...
                                                <p id="shipping_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                                    <label class="" for="shipping_city">省/市<abbr title="required" class="required">*</abbr>
                                                    </label>
                                                ...
                                                <p id="shipping_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                                    <label class="" for="shipping_state">县区</label>
                                                ...
                                                <p id="shipping_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                    <label class="" for="shipping_postcode">邮政编码<abbr title="required" class="required">*</abbr>
                                                    </label>
                                            ...
                                            <p id="order_comments_field" class="form-row notes">
                                                <label class="" for="order_comments">订单说明</label>
                                ...
                                <div id="order_review" style="position: relative;">
                                    <table class="shop_table">
                                        ...
                                        <tbody>
                                           ...
                                           <tr class="cart_item">
                                                <td class="product-name">
                                                    <%#Eval("Name") %><strong class="product-quantity">x <%#Eval("Quantity") %></strong> </td>
                                                <td class="product-total">
                                                    <span class="amount"><%#Eval("SingleTotal")%></span> </td>
                                            </tr>
                                             </ItemTemplate>
                                          </asp:Repeater>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th >购物车商品总数</th>
                                                <td id="cmount" runat="server"><span class="amount">£15.00</span>
                                                </td>
                                            </tr>

                                            <tr class="cart-subtotal">
                                                <th >购物车价格总计</th>
                                                <td id="cprice" runat="server" ><span class="amount">£15.00</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>订单总计</th>
                                                <td><strong><span id="amount" runat="server">£15.00</span></strong> </td>
                                            </tr>
                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            <li class="payment_method_bacs">
                                                ...
                                                <div class="payment_box payment_method_bacs">
                                                    <p>将付款直接付款到我们的银行帐户。请使用您的订单ID作为付款参考。在我们的帐户资金清算之前，您的订单将不会发货。</p>
                                                </div>
                                            </li>
                                            <li class="payment_method_cheque">
                                                <input type="radio" data-order_button_text="" value="cheque" name="payment_method" class="input-radio" id="payment_method_cheque">
                                                <label for="payment_method_cheque">检查付款 </label>
                                        ...
                                        <div class="form-row place-order">
                                            ...
                                            <input type="submit" data-value="确认订单" value="确认订单" id="place_order" name="woocommerce_checkout_place_order" class="button alt">
        ...
        jQuery(document).ready(function ($) {
            ...
            $.post(
                             ...
                             function (data) {
                                 ...
                                 $(".Add").val(jsonObj.Address);
                                 $(".Tel").val(jsonObj.TelNo);
